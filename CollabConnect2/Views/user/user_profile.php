...
<?php
require_once '..\..\controllers\auth\auth_inc.php';//session start se trouve dans ce fichier
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="..\..\storage\images\<?php echo $infos[0]["IMAGE"]; ?>" alt="Profile" class="rounded-circle">
              <h2><?php echo $infos[0]["NOM"]." ".$infos[0]["PRENOM"]; ?></h2>
              <h3><?php echo $infos[0]["POSTE"];?></h3>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $infos[0]["NOM"]; ?></div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Prénom</div>
                    <div class="col-lg-9 col-md-8"><?php echo $infos[0]["PRENOM"]; ?></div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Date Naissance</div>
                    <div class="col-lg-9 col-md-8"><?php 
                    // Date de naissance récupérée depuis $infos
                    $date_naissance = $infos[0]["DATE_NAISSANCE"]; 
                    // Convertir la date en format timestamp
                    $timestamp = strtotime($date_naissance);
                    // Formater la date au format "jj/mm/aaaa"
                    $date_formattee = date("d/m/Y", $timestamp);
                    echo $date_formattee; ?></div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Poste</div>
                    <div class="col-lg-9 col-md-8"><?php echo $infos[0]["POSTE"]; ?></div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Adresse</div>
                    <div class="col-lg-9 col-md-8"><?php echo $infos[0]["ADRESSE"]; ?></div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Ville</div>
                    <div class="col-lg-9 col-md-8"><?php echo $infos[0]["VILLE"]; ?></div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Code postal</div>
                    <div class="col-lg-9 col-md-8"><?php echo $infos[0]["CODE_POSTAL"]; ?></div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Pays</div>
                    <div class="col-lg-9 col-md-8"><?php echo $infos[0]["PAYS"]; ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Téléphone</div>
                    <div class="col-lg-9 col-md-8"><?php echo $infos[0]["TELEPHONE"]; ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8"><?php echo $infos[0]["EMAIL"]; ?></div>
                  </div>
                  ...
                  <form action="..\..\controllers\user\modifier_profile.php" method="POST" enctype="multipart/form-data">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="..\..\storage\images\<?php echo $infos[0]["IMAGE"]; ?>" alt="Profile">
                        <div class="pt-2">
