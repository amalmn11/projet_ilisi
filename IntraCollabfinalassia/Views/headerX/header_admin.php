...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="../admin/admin_profile.php" class="logo d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="rechercher.php">
        ...
        <!-- <select name="table" id="" class="form-select"><option value=""></option></select> -->
      </form>
    </div><!-- End Search Bar -->
