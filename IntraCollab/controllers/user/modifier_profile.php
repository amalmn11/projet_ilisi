...
//la requete
$req_modif="UPDATE utilisateur SET NOM=?,PRENOM=?,TELEPHONE=?,EMAIL=?,IMAGE=?,POSTE=? where UTILISATEUR_ID=?";
...
$stmt_modif->bindValue(3,$newTel,PDO::PARAM_STR);
$stmt_modif->bindValue(4,$newEmail,PDO::PARAM_STR);
$stmt_modif->bindValue(5,$file_name,PDO::PARAM_STR);//traitement d'image , on va met e nom d'image dans la bd
$stmt_modif->bindValue(6,$newPoste,PDO::PARAM_STR);
