...
foreach ($termsArray as $index => $term) {
    ...
    $whereClausesConnaissances[] =  "(TAG1 LIKE $paramName OR TAG2 LIKE $paramName OR TAG3 LIKE $paramName)";//Pour rechercher dans annonce
...
$lignes = $stmt_connaissance->fetchAll(PDO::FETCH_ASSOC);
$nb = count($lignes);
?>
