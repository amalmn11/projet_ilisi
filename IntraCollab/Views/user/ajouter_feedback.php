...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Ajouter Feedback</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
<div class="box-footer">
    <form action="..\..\controllers\user\ajouter_feedback.php" method="POST">
        <img class="img-responsive img-circle img-sm" src="../../storage/images/<?php echo $_SESSION["image"]; ?>" alt="Alt Text">
        <div class="img-push">
            <!-- Quill Editor Full -->
            <div>
            <textarea class="form-control" rows="5" name="feedback"  placeholder="Ajouter feedback ..."></textarea>
            ...
            <button style="BORDER-RADIUS: 7px;" type="submit" id="btn-submit" name="ajouterReponse" class="share-button">
                <i class="fas fa-share"></i> Ajouter
            </button>
            </div>
    </form>   
</div>
...
<?php 
              if ($_SESSION['user_id'] == $feedback['UTILISATEUR_ID']) {
                ...
                echo '<div style="float: right;"><a id="icon" href="..\..\controllers\user\supprimer_feedback.php?IDD=' . $feedback['ID_FEEDBACK'] . '" type="button" class="my-btn">
                <i class="bi bi-trash"></i>
                </a> 
                <a style="margin:5px" id="editBtn" type="button" href="modifier_feedback.php?id_fb='. $feedback['ID_FEEDBACK'] . '" class="my-btn editBtn" >
