...
<head>
    ...
    <link rel="stylesheet" href="..\..\assets\css\formation_projet.css">
</head>
<body>
<main id="main" class="main">
    
    <div class="profile-description">
        <i style="font-size: 30px; display: inline-block;" class="bi bi-headset"></i>
        <h2 style="display: inline;">Formations</h2>
        <?php  foreach($formation as $ligne): ?>
        <div class="profile-desc-row"> 
            <img src="..\..\assets\img\favicon.png"> 
            <div>
                <h4><?php  echo $ligne['THEME']; ?></h4>
                <div id="info">
                    ...
                    <div class="disc">
                        <b style="display:inline-block">Description : </b>
                        <p id="pp"><?php  echo $ligne['FORMATION_DESCR']; ?></p>
                    </div>
                    <div class="lieen">
                        <a style="underline:none; color:#343a40;" href="<?php  echo $ligne['FORMATION_LIEN']; ?>"><b>Lien de la formation : </b><?php  echo $ligne['FORMATION_LIEN']; ?></a>
                    </div>
                </div>
    ...
    <div style="margin-top:20px" class="profile-description">
        ...
        <div class="profile-desc-row"> 
            ...
            <div>
                ...
                <i id="icon" style="font-size: 25px; display: inline-block; cursor: pointer;" class="bi bi-pen"></i>
                <hr style="height: 1.5px; background-color: rgba(0, 0, 0, 0.8);">
            </div>
        </div>
        <?php  endforeach; ?>
